const en = {
    ...
    userHome: {
        ...
        catalogue: {
            ...
            ourApps: "Our apps",
            ourAppsInfo: "The apps your organisation offers on SURF Access",
            maintainOurApps: "Manage our apps",
            allApps: "All other apps",
            openCatalogue: "Open the application catalog",
        },
        decentral: {
            title: "Decentralised access management",
            subTitle: "Delegate member management and application access to collaborations.",
            collaborations: "Collaborations",
            maintainCollaborations: "Manage collaborations",
    ...
    connect: {
        ...
        serviceBullets: [
            "<strong>Stap 1</strong>: Log in to SURF Access",
            "<strong>Stap 2</strong>: Choose your organisatie. Use eduID if you do not have an institution account.",
            "<strong>Stap 3</strong>: Create a new application. Enter the required information.",
            "<strong>Stap 4</strong>: Create a new connection for the application. Enter the required formal and technical information. ",
            "<strong>Stap 5</strong>: Request the connection and wait for confirmation. You will receive a message at acceptance or denial.",
            ],
