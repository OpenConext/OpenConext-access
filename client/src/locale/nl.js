const nl = {
    ...
    userHome: {
        ...
        catalogue: {
            title: "Applicatie catalogus",
            subTitle: "Beheer je eigen apps en vind nieuwe.",
            ourApps: "Onze apps",
            ourAppsInfo: "De apps die je organisatie op SURF Access aanbiedt",
            maintainOurApps: "Beheer onze apps",
            allApps: "Alle overige apps",
            openCatalogue: "Open de applicatie catalogus",
        },
        decentral: {
            title: "Gedecentraliseerd toegangsbeheer",
            subTitle: "Delegeer ledenbeheer en applicatietoegang aan samenwerkingen.",
            collaborations: "Samenwerkingen",
            maintainCollaborations: "Beheer samenwerkingen",
    ...
    error: {
        title: "Oeps, fout!!!",
        unexpected: "Er is een onverwachte fout opgetreden. Neem contact op met <a href='mailto:support@surfaccess.nl'>support@surfaccess.nl</a> voor ondersteuning.",
