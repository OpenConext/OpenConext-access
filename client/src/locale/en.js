const en = {
    ...
    appAccess: {
        ...
        rolesTitle: "Roles",
        addRole: "Add role",
        noRolesTitle: "This application doesn't receive any roles for access yet.",
        noRolesInfo: "There is no SCIM provisioning yet, so roles don't automatically grant access to this application. To give a role access to the application, a rule must be created.",
        details: "Details",
    ...
    consent: {
        ...
        warnings: "You can optionally add a warning to the consent screen stating the application is not an official institutional app and no support should be expected. See our <a class='actionable' href='https://servicedesk.surf.nl/wiki/spaces/IAM/pages/74220197/Inloggen+via+SURFconext' target='_blank'>wiki</a> (Dutch) for details.",
