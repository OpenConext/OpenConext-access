const en = {
    ...
    landing: {
        ...
        loginInfo: {
            ...
            subTitle: "je kunt op OpenConext Access inloggen met een bestaand instellingsaccount, of als je deze niet met een MyConext. Kies hieronder je situatie",
            commercial: {
                title: "Je werkt bij een (commercieel) bedrijf",
                info: [
                    "Maken jullie zelf software die je wilt aanbieden in het onderwijsveld?",
                    "Dan moet je inloggen met MyConext. Heb je nog geen account, geen zorgen, het aanmaken van een nieuwe account kan binnen 30 seconden"
                ],
                login: "Login met MyConext"
            },
            education: {
                title: "Je werkt bij een instelling",
                info: [
                    "Ben je medewerker, student of onderzoeker bij een instelling die al is aangesloten op OpenConext, dan kan je direct inloggen met je instellingsaccount."
                ],
    ...
    navigation: {
        ...
        catalogue: "OpenConext app catalogue",
        yourApps: "Your apps",
        allApps: "All apps",
    ...
    organizations: {
        ...
        tooltipApproved: "OpenConext heeft je organisastie registratie goedgekeurd. Je kunt apps registreren op onze productie omgevingn en productie status aanvragen.",
    ...
    organization: {
        ...
        catalog: {
            ...
            fairUseExternal: "Is je app voor een specifieke groep gebruikers (zoals één onderzoeksgroep)? Dan valt deze onder de <a href='https://OpenConext.nl/fair-use' target='_blank'>Fair use gebruiksvoorwaarden</a>.",
            agreementExternal: "Is je app bedoeld voor gebruik door hele onderwijsinstellingen? Dan teken je een <a href='https://OpenConext.nl/fair-use' target='_blank'>OpenConext-aansluitovereenkomst</a>.",
    ...
    connection: {
        ...
        production: {
            ...
            contract: "Contract",
            disclaimer: "Een koppeling aan de productieomgeving van OpenConext Access heeft goedkeuring nodig van team OpenConext Access. Alle bovenstaande informatie is verplicht.",
        },
        ...
        testIdP: "Test-IdP's",
        visibility: "Zichtbaarheid in de OpenConext app catalogus",
        help: "Hulp nodig?",
        ...
        protocol: "Protocol",
        protocolTooltip: "When a connection is registered within OpenConextconext, it is no longer possible to change the protocol. If you want, you can delete this connection and create another with a different protocol.",
        clientID: "Client ID",
        clientIDPlaceHolder: "",
        oidc10_rp: "OIDC",
        saml20_sp: "SAML",
        ...
        connections: {
            ...
            tooltips: {
                ...
                complete: null,
                pending_prod: "Je productieverzoek ligt ter inzage bij <strong>OpenConext Access</strong>. Eén van onze medewerkers beoordeelt nu de configuratie en laat zo snel mogelijk weten of deze akkoord is.<br><br> Na publicatie kunnen instellingen aan je applicatie koppelen.",
        ...
        visibilities: {
            info: "Jouw app is straks zichtbaar in de OpenConext app catalogus. Instellingen of groepen die jouw applicatie willen gebruiken, kunnen deze zelf activeren of een koppeling aanvragen.",
        ...
        connectionOverviewSAML: {
            ...
            link: "Volg de <a href='https://servicedesk.OpenConext.nl/wiki/spaces/IAM/pages/128910223/Connect+to+the+test+environment' target='_blank'>testinstructies</a> om te kijken of alles werkt."
        },
        appInfo: {
        ...
        contacts: {
            ...
            administrativePlaceholder: "e.g. admin@{{name}}.nl",
    ...
    institutions: {
        title: "Institutions",
        subTitle: "Browse the institutions currently connected to OpenConext Access, categorized into education, research and affiliated institutions.",
        category: "Category",
        all: "All categories",
        other: "Other",
    ...
    applications: {
        title: "Applications",
        subTitle: "Browse applications currently connected to OpenConext Access, categorized into categories. Some are connected directy via OpenConextconext, others via eduGAIN..",
        category: "Category",
        all: "All categories",
    ...
    applicationDetail: {
        ...
        back: "Terug",
        license: {
            license_available_through_OpenConextmarket: "Requires a license through OpenConextmarket",
        ...
        privacy: "Privacy",
        privacyInfo: "OpenConext asks suppliers to provide information about their GDPR (AVG) policies. For anything missing, please contact the supplier.",
        ...
        wiki: " See the <a href='https://support.OpenConextconext.nl/contract-info-nl' target='_blank' rel='noopener noreferrer'>wiki</a>.",
        noInformation: "No information supplied",
        contractualInfoOrganization: "(This application is offered by {{name}}.)",
        contractualBase: {
            na: "No info on the contractual base is available: for any questions, please contact <a href='mailto:support@OpenConextconext.nl'>support@OpenConextconext.nl</a>.",
            ao: "{{organisation}} has signed the OpenConextconext connection agreement.",
            ix: "Application offered by OpenConextconext member institution.",
            ...
            none: "{{organisation}} refused to sign the OpenConextconext connection agreement.",
        ...
        registrationInfo: "This application provider is available in OpenConextconext through <a href='https://support.OpenConextconext.nl/edugain' target='_blank' rel='noopener noreferrer'>eduGAIN</a>. " +
    ...
    connect: {
        ...
        fairUse: "<a href='https://www.OpenConext.nl/en/services/identity-access-management/OpenConextconext' target='_blank'>Fair Use Policy</a>",
        accessTOS: "<a href='https://www.OpenConext.nl/en/services/identity-access-management/OpenConextconext' target='_blank'>OpenConext Access TOS</a>",
        connectionAgreement: "<a href='https://www.OpenConext.nl/en/services/identity-access-management/OpenConextconext' target='_blank'>Connection agreement</a>",
        OpenConextMember: "OpenConext member",
        notNeeded: "not needed",
        memberAgreement: "<a href='https://www.OpenConext.nl/en/services/identity-access-management/OpenConextconext' target='_blank'>Member agreement</a>",
        OpenConextMemberInfo: "including affiliated organisations",
        ...
        technicalInfo: "Whenever a user logs in through OpenConext Access, their information flows from their home-institution (Identity provider), via OpenConext Access, directly to your service.",
