const en = {
    ...
    assurance: {
        mfaTitle: "MFA at institution's IdP",
        mfaInfo: "Use MFA to require a second factor via your IdP. Choose REFEDS MFA or Microsoft MFA (ADFS/Azure AD). If unsupported, use SURFsecureID.",
        mfaLevel: "MFA level",
        stepupTitle: "MFA via SURFsecureID",
        stepupInfo: "Assurance levels add a second factor to the login. The higher the LoA, the stronger the security.",
        ...
        stepup: {
            loa1_5: "LoA 1.5: Password + second factor",
            loa2: "LoA 2: Strong authentication",
            loa3: "LoA 3: Highest assurance",
        },
        flash: {
