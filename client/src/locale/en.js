const en = {
    ...
    welcome: {
        ...
        info: "Select your organisation or add a new one.",
        ...
        applications: "applications",
        zeroState: "No organisations found for '{{name}}'",
        register: "Is your organisation not listed?",
        registerLink: "Register '{{name}}' as a new Organisation",
    ...
    userHome: {
        ...
        newOrganizationDescription: "We usually review the details within 3 business days. You can get started right away.",
        newJoinRequestDescription: "Your request to join {{name}} has been sent to the administrator.",
    ...
    joinRequest: {
        ...
        optionalMessageInfo: "This message is included in your request.",
    ...
    application: {
        ...
        type: "Is this an application or content service?",
        typeApp: "Application - software people use (tool, cloud service, utility)",
        typeContent: "Content service - access to learning material (educational content, e-books)",
        contentAbbreviation: "Content",
        contentInfoPre: "A content service receives as little personal data from users as possible (",
        contentInfoLink: "this minimum set of attributes",
        contentInfoPost: ").",
        ...
        outstandingPolicies: "This application cannot be deleted because there are outstanding access rules. Please contact <a class='actionable' href='mailto:support@surfconext.nl'>support@surfconext.nl</a> if you want this application deleted.",
    ...
    organization: {
        ...
        catalog: {
            ...
            fairUse: "Is your app for a specific group of users (such as a single research group)? Then it falls under the <a class='actionable' href='https://surf.nl/fair-use' target='_blank'>Fair Use Policy</a>.",
            agreement: "Is your app intended for use by entire educational institutions? Then you sign a <a class='actionable' href='https://surf.nl/fair-use' target='_blank'>SURF Connection Agreement</a>.",
            ...
            fairUseExternal: "Is your app for a specific group of users (such as a single research group)? Then it falls under the <a class='actionable' href='https://surf.nl/fair-use' target='_blank'>Fair Use Policy</a>.",
            agreementExternal: "Is your app intended for use by entire educational institutions? Then you sign a <a class='actionable' href='https://surf.nl/fair-use' target='_blank'>SURF Connection Agreement</a>.",
    ...
    connection: {
        ...
        inUseTip: "We strongly recommend contacting <a class='actionable' href='mailto:support@surfconext.nl'>support@surfconext.nl</a>, if you really want to delete this {{unit}}.",
        units: {
        ...
        overviewCards: {
            ...
            appInformationPrivacy: "Privacy and security",
            connections: "Connection(s)",
            createConnection: "Create connection",
            appTeam: "App team",
            teamMemberSolo: "1 team member",
            teamMemberSoloYou : " (you)",
            teamMemberMulti: "{{count}} team members",
            teamMemberMultiYou : " (incl. you)",
        },
        ...
        pkce: "PKCE",
        pkceTooltip: "PKCE is a security check that stops someone else from hijacking the sign-in process.<br><br>It works by having the app generate a one-time secret code and prove it holds that code when it exchanges the login for tokens.",
        clientTypeQuestion: "How does this application run?",
        clientType: {
            confidential: "On a server I control, where I can keep a secret safe (e.g. backend service, server-rendered app)",
            confidentialDescription: "A client secret will be issued. PKCE is optional but recommended.",
            public: "In a browser or on a device, where a secret could be extracted (e.g. single-page app, mobile app)",
            publicDescription: "No client secret will be issued. PKCE is required.",
        },
        ...
        outstandingPolicies: "This connection cannot be deleted because there are outstanding policies. Please contact <a class='actionable' href='mailto:support@surfconext.nl'>support@surfconext.nl</a> if you need this connection to be deleted.",
        ...
        scopes: "Scopes",
        scopePlaceholder: "Add unique scopes for this RS",
        scopeInfo: "If you create scopes, please prefix them with your unique domain (e.g. '{{schachome}}-scope')",
        ...
        visibilities: {
            ...
            who: "How do you want to make the application available?",
            visible_to_all: "Via the app catalog",
            visible_to_allDescription: "The application becomes visible in the app catalog and on surfaccess.nl.",
            visible_to_idp_only: "Only employees of linked institutions",
            visible_to_none: "Via a direct link",
            visible_to_noneDescription: "The app is not shown in the app catalog. You get a link to use yourself or share with an institution.",
            connect: "How can institutions activate this application?",
            connect_with_interaction: "I want to approve requests first",
            connect_without_interaction_with_email: "Direct, with email notification",
            connect_without_interaction_without_email: "Direct, no email notification",
        ...
        privacy: {
            ...
            termsAreRequired: "You need to confirm with the terms",
        },
        appOverview: {
        ...
        productionStatusSection: {
            ...
            nextStep: "Next",
            postponePublish: "Publish later",
            doneAndContinue: "Done and continue",
            appInformationIncomplete: "Before requesting production-ready status,</br>all the application information must be filled in",
            pendingProdDisclaimerTitle: "This connection is pending production-ready status.",
            pendingProdDisclaimerDescription: "You will be contacted by mail once the request has been approved.",
        ...
        testConnectionSection: {
            ...
            infoRS: "Use the information below to configure the resource server.",
        ...
        customersSection: {
            question: "Which customers ('OpenID Connect' connections) do you want to grant access to?",
        },
    },
    testing: {
    ...
    appTeamManagement: {
        ...
        new: "Invite new user",
        addButton: "Add user",
        selectLabel: "Name or email address",
    ...
    applicationDetail: {
        ...
        wiki: " See the <a class='actionable' href='https://support.surfconext.nl/contract-info-nl' target='_blank' rel='noopener noreferrer'>wiki</a>.",
        noInformation: "No information supplied",
        contractualInfoOrganization: "(This application is offered by {{name}}.)",
        contractualBase: {
            na: "No info on the contractual base is available: for any questions, please contact <a class='actionable' href='mailto:support@surfconext.nl'>support@surfconext.nl</a>.",
        ...
        registrationInfo: "This application provider is available in SURFconext through <a class='actionable' href='https://support.surfconext.nl/edugain' target='_blank' rel='noopener noreferrer'>eduGAIN</a>. The application provider is registered by the following federation: <a class='actionable' href='{{url}}' target='_blank' rel='noopener noreferrer'>{{url}}</a>.",
    ...
    feedback: {
        ...
        disclaimer: "We will use this information to fix problems, improve our products and help you. We may follow up with you regarding your feedback. For more information, please review our <a class='actionable' target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://edu.nl/fcgbd\">Privacy Notice</a>.",
        help: "Need help?",
        helpInfo: "For questions or issues, please reach out to us at <a class='actionable' href='mailto:support@surf.nl'>support@surf.nl</a>",
    ...
    footer: {
        ...
        versionLink: "https://github.com/OpenConext/OpenConext-access/milestone/6?closed=1",
    },
    profile: {
        title: "Profile",
    ...
    applicationConnect: {
        ...
        disconnectConfirmTitle: "Do you want to deactivate the app?",
        disconnectRequested: "Request to deactivate",
        disconnectRequestedTest: "Disconnect",
        disconnectRequestedQuestion: "In order to deactivate access to this application, we will create a ticket for SURF support. They will deactivate the application.",
    ...
    appAccess: {
        ...
        requestedAccessNotification: "You have requested access to this application - ticket {{ticketKey}}. If the supplier (SP) approves this, you can manage access to the app below. If you don't want to connect, you can cancel your request",
        requestedDisconnectNotification: "You have requested to have no longer access to this application - ticket {{ticketKey}}. If you don't want to disconnect, you can cancel your request",
    ...
    consent: {
        title: "Consent",
        example: "Example",
        info: "The first time a user logs in to this application, a dialog may be shown asking the user for consent to send personal data to this application. See our <a class='actionable' href='https://servicedesk.surf.nl/wiki/spaces/IAM/pages/74220197/Inloggen+via+SURFconext' target='_blank'>wiki</a> (Dutch) for more information.",
        ...
        warnings: "You can optionally add a warning to the consent screen, for example to indicate that the application is not an official app of the institution and no support can be expected.",
        warningEN: "Warning in English",
        warningNL: "Warning in Dutch",
        // These preview the text the field expects, in that field's own language -
        // not the current UI locale - so the value is intentionally the same here
        // and in nl.js.
    ...
    error: {
        title: "Whoops, error!!!",
        unexpected: "An unexpected error occurred. Please contact <a class='actionable' href='mailto:support@surfaccess.nl'>support@surfaccess.nl</a> for support.",
    ...
    policies: {
        ...
        subTitle: "Select an application to see the rules that apply.",
        newPolicy: "Add new rule",
        policyTypesPlaceholder: "Access rules and Assurance rules",
        ...
        backToApplication: "Back to application {{name}}",
    ...
    contracts: {
        ...
        organizationNameDescription: "Name in the agreement",
        country: "Country",
        update: "Update",
        ...
        submitConfirmation: {
            title: "Agreement is being drawn up",
            message: "Based on this information an agreement will be drawn up. This agreement will be sent to the provided email address for signing within 3 working days.",
            confirm: "Send",
        },
        flash: {
    ...
    monitoring: {
        ...
        selectApp: "Select an app to see details here.",
        uptimeTitle: "Uptime",
