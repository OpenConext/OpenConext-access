const nl = {
    ...
    appAccess: {
        ...
        noPoliciesFound: "Geen regels gevonden",
        addAccessRule: "Toegangsregel toevoegen",
        addAssuranceRule: "Assuranceregel toevoegen",
        rolesTitle: "Rollen",
        addRole: "Rol toevoegen",
        noRolesTitle: "Deze applicatie ontvangt nog geen rollen voor toegang.",
        noRolesInfo: "Er is nog geen SCIM provisioning, waardoor de rollen niet automatisch toegang geven tot deze applicatie. Om de rol toegang te geven tot de applicatie moet een regel worden aangemaakt.",
        details: "Details",
