const en = {
    ...
    connection: {
        ...
        contract: "Contract",
        appteam: "App team",
        welcome: "Welcome {{user}}. {{name}} is not yet connected to SURF Access. Start by creating a connection.",
        testSection: "Test",
        teamSection: "Team",
        ...
        test: {
            name: "Connections",
            connections: "Connections not activated for production yet",
            info: "Test whether federated login works.",
        },
        ...
        production: {
            name: "Connections",
            connections: "All connections for {{app}}",
            catalogue: "App details for the SURF Access catalog",
            access: "Access & visibility",
            contract: "Contract",
            disclaimer: "To activate a connection for production you will need approval from the SURF Access team. All of the above information is mandatory.",
        },
        ...
        newConnectionProd: "New connection",
        ...
        connectionPlaceholder: "e.g. {{application}}-connection",
        protocol: "Protocol",
