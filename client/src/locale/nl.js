const nl = {
    ...
    welcome: {
        ...
        applications: "applicaties",
        zeroState: "Geen organisaties gevonden voor '{{name}}'",
        register: "Staat je organisatie hier niet tussen?",
        registerLink: "Registreer '{{name}}' als nieuwe organisatie",
    ...
    userHome: {
        ...
        newOrganizationDescription: "We controleren de gegevens meestal binnen 3 werkdagen. Je kunt al direct aan de slag.",
        newJoinRequestDescription: "Je verzoek om lid te worden van {{name}} is naar de beheerder gestuurd.",
    ...
    joinRequest: {
        ...
        optionalMessage: "Bericht",
        optionalMessageInfo: "Dit bericht wordt meegestuurd met je aanvraag.",
    ...
    application: {
        ...
        type: "Is het een applicatie of contentdienst?",
        typeApp: "Applicatie - software die mensen gebruiken (tool, cloud-service, utility)",
        typeContent: "Contentdienst - toegang tot leermateriaal (educatieve content, e-books)",
        contentAbbreviation: "Content",
        contentInfoPre: "Een contentdienst ontvangt zo min mogelijk persoonlijke gegevens van gebruikers (",
        contentInfoLink: "deze minimumset attributen",
        contentInfoPost: ").",
    ...
    connection: {
        ...
        overviewCards: {
            title: "Overzicht",
            subTitle: "Vul alle informatie hieronder in om je applicatie te publiceren op SURF Access.",
            appInformation: "App-informatie",
            appInformationLogo: "Logo en beschrijving",
            appInformationContact: "Contactgegevens",
            appInformationPrivacy: "Privacy- en beveiliging",
            connections: "Koppeling(en)",
            createConnection: "Koppeling aanmaken",
            appTeam: "App-team",
        ...
        pkce: "PKCE",
        pkceTooltip: "PKCE is een beveiligingscontrole die voorkomt dat iemand anders het inlogproces kaapt.<br><br>Het werkt doordat de app een eenmalige geheime code genereert en bewijst dat zij deze code heeft bij het inwisselen van de login voor tokens.",
        clientTypeQuestion: "Hoe draait deze applicatie?",
        clientType: {
            confidential: "Op een server die ik beheer, waar ik een secret veilig kan bewaren (bijv. backend-service, server-rendered app)",
            confidentialDescription: "Er wordt een client secret uitgegeven. PKCE is optioneel maar aanbevolen.",
            public: "In een browser of op een apparaat, waar een secret buitgemaakt kan worden (bijv. single-page app, mobiele app)",
            publicDescription: "Er wordt geen client secret uitgegeven. PKCE is verplicht.",
        },
        ...
        scopeInfo: "Als je scopes aanmaakt, voeg dan een unieke domein ervoor toe (bijv. '{{schachome}}-scope').",
        ...
        visibilities: {
            ...
            who: "Hoe wil je de applicatie beschikbaar maken?",
            visible_to_all: "Via de app-catalogus",
            visible_to_allDescription: "De applicatie wordt zichtbaar in de app-catalogus en op surfaccess.nl.",
            visible_to_idp_only: "Alleen medewerkers van gekoppelde instellingen",
            visible_to_none: "Via een directe link",
            visible_to_noneDescription: "De app komt niet in de app-catalogus. Je krijgt een link om zelf te gebruiken of te delen met een instelling.",
            connect: "Hoe kunnen instellingen deze applicatie activeren?",
            connect_with_interaction: "Ik wil aanvragen eerst goedkeuren",
            connect_without_interaction_with_email: "Direct, wel e-mailnotificatie",
            connect_without_interaction_without_email: "Direct, geen e-mailnotificatie",
        ...
        productionStatusSection: {
            ...
            nextStep: "Volgende",
            postponePublish: "Later publiceren",
            doneAndContinue: "Klaar en doorgaan",
            appInformationIncomplete: "Voordat de status 'productieklaar' wordt aangevraagd,</br> moet alle applicatie-informatie zijn ingevuld",
            pendingProdDisclaimerTitle: "Deze koppeling wacht op de status 'gereed voor productie'",
            pendingProdDisclaimerDescription: "Je ontvangt een mail zodra het verzoek is goedgekeurd.",
            readyTitle: "De koppeling is live!",
            readyDescription: "De koppeling is klaar voor gebruik. Deel onderstaande link<br/>met instellingen die de applicatie willen activeren.",
            copyUrl: "Kopieer URL",
            contractRequired: "Voordat de status 'productieklaar' wordt aangevraagd, moet het contract goedgekeurd zijn",
        ...
        testConnectionSection: {
            ...
            infoRS: "Gebruik de gegevens hieronder om de resource server te configureren.",
        ...
        customersSection: {
            question: "Welke afnemers ('OpenID Connect'-koppelingen) geef je toegang?",
        },
    },
    testing: {
    ...
    appTeamManagement: {
        ...
        selectLabel: "Naam of e‑mailadres",
        addPlaceHolder: "Selecteer gebruiker",
        addSubmit: "Toevoegen",
        inviteNewUserPre: "Staat de gebruiker nog niet in de lijst? ",
        inviteNewUserLink: "Nodig een nieuwe gebruiker uit voor SURF Access",
        remove: "Verwijderen uit app‑team",
        deleteConfirmation: "Weet je zeker dat je de applicatierol voor {{name}} wilt verwijderen?",
        organizationMembersPre: "Je kunt gebruikers toevoegen aan dit app‑team. Ze zijn ook vindbaar onder ",
        organizationMembersLink: "SURF Access gebruikers",
    ...
    invitation: {
        ...
        intendedAuthorityLong: "SURF Access rol",
    ...
    applicationConnect: {
        ...
        disconnectConfirmTitle: "Wil je de app deactiveren?",
        disconnectRequested: "Verzoek tot deactiveren",
        disconnectRequestedTest: "Ontkoppel",
        disconnectRequestedQuestion: "Om toegang tot deze applicatie te deactiveren, maken we een ticket aan bij SURF support. Zij zullen de applicatie deactiveren.",
    ...
    appAccess: {
        ...
        addAccessRule: "Toegangsregel toevoegen",
    ...
    consent: {
        title: "Toestemming",
        example: "Voorbeeld",
        info: "Als de gebruiker de eerste keer inlogt bij deze applicatie kan een dialoog getoond worden waarin de gebruiker toestemming wordt gevraagd voor het versturen van persoonsgegevens naar deze applicatie. Zie onze <a class='actionable' href='https://servicedesk.surf.nl/wiki/spaces/IAM/pages/74220197/Inloggen+via+SURFconext' target='_blank'>wiki</a> voor meer informatie.",
        ...
        warnings: "Voeg optioneel een waarschuwing toe aan het toestemmingsscherm waarin je bijvoorbeeld kunt aangeven dat de applicatie geen officiële app van de instelling is en er geen ondersteuning verwacht kan worden.",
        warningEN: "Waarschuwing in het Engels",
        warningNL: "Waarschuwing in het Nederlands",
        // Deze tonen een voorbeeld in de taal van het veld zelf - niet de UI-taal -
        // dus de waarde is bewust hetzelfde hier en in en.js.
        warningENPlaceholder: "Pay attention...",
        warningNLPlaceholder: "Let op...",
        flash: {
    ...
    policies: {
        ...
        policyTypesPlaceholder: "Toegangsregels en Betrouwbaarheidsregels",
        ...
        backToApplication: "Terug naar applicatie {{name}}",
    ...
    contracts: {
        ...
        organizationNameDescription: "Naam in de overeenkomst",
        country: "Land",
        update: "Opslaan",
        ...
        submitConfirmation: {
            title: "Overeenkomst wordt opgesteld",
            message: "Op basis van deze gegevens wordt een overeenkomst opgesteld. Deze overeenkomst wordt binnen 3 werkdagen ter ondertekening naar het opgegeven e-mailadres gestuurd.",
            confirm: "Versturen",
        },
        flash: {
    ...
    monitoring: {
        ...
        selectApp: "Selecteer een app om de details hier te zien.",
        uptimeTitle: "Uptime",
